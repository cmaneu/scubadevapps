# scubawarm - Infrastructure as code
...
```
curl "https://nubesgen.com/scubawarm.tgz?iactool=BICEP&region=francecentral&application=APP_SERVICE.standard&runtime=DOCKER&database=NONE.free&addons=application_insights&gitops=true" | tar -xzvf -
```
