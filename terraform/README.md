...
```
curl "https://nubesgen.com/scubadevapps.tgz?iactool=TERRAFORM&region=francecentral&application=APP_SERVICE.free&runtime=DOCKER&database=NONE.free&gitops=true" | tar -xzvf -
```
