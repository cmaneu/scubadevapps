...
```
curl "https://nubesgen.com/scubawarm.tgz?iactool=TERRAFORM&region=francecentral&application=APP_SERVICE.standard&runtime=DOCKER&database=NONE.free&addons=application_insights&gitops=true" | tar -xzvf -
```
