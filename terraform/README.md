...
```
curl "https://nubesgen.com/scubadevapps.tgz?iactool=TERRAFORM&region=francecentral&application=APP_SERVICE.free&runtime=DOCKER&database=SQL_SERVER.serverless&addons=storage_blob&gitops=true" | tar -xzvf -
```
